# Generated by Django 3.1.14 on 2023-05-03 17:10
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(help_text='Адрес электронной почты', max_length=254, unique=True, validators=[django.core.validators.EmailValidator(message='Некорректный email')], verbose_name='Адрес электронной почты')),
